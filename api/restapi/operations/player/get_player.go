...
type GetPlayerHandlerFunc func(GetPlayerParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetPlayerHandlerFunc) Handle(params GetPlayerParams) middleware.Responder {
	return fn(params)
}

// GetPlayerHandler interface for that can handle valid get player params
type GetPlayerHandler interface {
	Handle(GetPlayerParams) middleware.Responder
}
...
/*
	GetPlayer swagger:route POST /player player getPlayer

GetPlayer get player API
*/
