...
func NewAresAPI(spec *loads.Document) *AresAPI {
	return &AresAPI{
		...
		PlayerGetPlayerHandler: player.GetPlayerHandlerFunc(func(params player.GetPlayerParams) middleware.Responder {
			return middleware.NotImplemented("operation player.GetPlayer has not yet been implemented")
		}),
	}
}

/*AresAPI oplanet consolidated api for ogame tools */
type AresAPI struct {
	spec            *loads.Document
...
func (o *AresAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *AresAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}
...
func (o *AresAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/player"] = player.NewGetPlayer(o.context, o.PlayerGetPlayerHandler)
}
...
func (o *AresAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
